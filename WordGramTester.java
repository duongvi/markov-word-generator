...
public class WordGramTester {
    ...
    public void testWordGramShiftAdd(){
        String source = "these are the words";
        String[] words = source.split("\\s+");
        WordGram wg = new WordGram(words, 0, 4);
        System.out.println(wg);
        System.out.println(wg.shiftAdd("Those").shiftAdd("blabla"));
    }
    
    public void testWordGramHash(){
        String source = "these are the words";
        String [] words = source.split("\\s+");
        WordGram wg = new WordGram(words, 0, 4);
        System.out.println(wg.hashCode() == source.hashCode());
    }
}
